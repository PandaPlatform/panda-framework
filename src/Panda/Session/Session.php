...
class Session
{
    ...
    /**
     * Construct the Session singleton.
     *
     * @param string $id   The session id.
     * @param string $name The session name.
     */
    protected function __construct($id = "", $name = "ss")
    {
        // Set options array
        $options = array(
            "id" => (empty($id) ? mt_rand() . "_" . time() : $id),
            "name" => (empty($name) ? "ss" : $name)
        );

        // Init session and set options
        $this->init($options);
    }
     ...
     * Init session.
     *
     * @param array $options A set of options like the session_id etc.
     */
    ...
    {
        $sessionCookie = CookieBox::getInstance()->get(session_name());
